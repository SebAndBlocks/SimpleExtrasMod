 ...
 *
 */
package tk.turquoisetnt.tntextras;
...
@Mod("tntextras")
public class TntextrasMod {
	public static final Logger LOGGER = LogManager.getLogger(TntextrasMod.class);
	public static final String MODID = "tntextras";
